...
package com.moonlight.client.baritone.api.utils.input;
...
public enum Input {
     ...
     */
    MOVE_FORWARD(s -> s.keyBindLeft),

    /**
     * The move back input
     */
    MOVE_BACK(s -> s.keyBindRight),

    /**
     * The move left input
     */
    MOVE_LEFT(s -> s.keyBindBack),

    /**
     * The move right input
     */
    MOVE_RIGHT(s -> s.keyBindJump),

    /**
     * The attack input
     */
    CLICK_LEFT(s -> s.keyBindPickBlock),

    /**
     * The use item input
     */
    CLICK_RIGHT(s -> s.keyBindDrop),

    /**
     * The jump input
     */
    JUMP(s -> s.keyBindSneak),

    /**
     * The sneak input
     */
    SNEAK(s -> s.keyBindSprint),

    /**
     * The sprint input
     */
    SPRINT(s -> s.keyBindInventory);
