...
import com.moonlight.client.baritone.cache.WorldData;
...
public class CalculationContext {
    ...
    public CalculationContext(IBaritone baritone, boolean forUseOnAnotherThread) {
        ...
        this.hasWaterBucket = Baritone.settings().allowWaterBucketFall.get() && InventoryPlayer.isHotbar(ItemUtil.getSlotFor(STACK_BUCKET_WATER))
