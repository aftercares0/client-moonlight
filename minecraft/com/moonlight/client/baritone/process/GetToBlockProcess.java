...
import com.moonlight.client.baritone.api.process.IGetToBlockProcess;
...
public class GetToBlockProcess extends BaritoneProcessHelper implements IGetToBlockProcess {
    ...
    private Goal createGoal(BlockPos pos) {
        ...
        if (blockOnTopMustBeRemoved(gettingTo) && baritone.bsi.get0(pos.up()).getBlock().isBlockNormalCube()) {
