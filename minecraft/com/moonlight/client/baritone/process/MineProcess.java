...
package com.moonlight.client.baritone.process;
...
import com.moonlight.client.baritone.api.process.IMineProcess;
import com.moonlight.client.baritone.api.process.PathingCommand;
import com.moonlight.client.baritone.api.process.PathingCommandType;
import com.moonlight.client.baritone.api.utils.IPlayerContext;
import com.moonlight.client.baritone.api.utils.RotationUtils;
import com.moonlight.client.baritone.cache.CachedChunk;
import com.moonlight.client.baritone.cache.ChunkPacker;
import com.moonlight.client.baritone.cache.WorldScanner;
...
import com.moonlight.client.baritone.utils.BaritoneProcessHelper;
...
public final class MineProcess extends BaritoneProcessHelper implements IMineProcess {
    ...
    public PathingCommand onTick(boolean calcFailed, boolean isSafeToCancel) {
        if (desiredQuantity > 0) {
            ...
            int curr = stacks.stream().filter(stack -> item.equals(stack.getItem())).mapToInt(ItemStack::getStackSize).sum();
    ...
    private static Goal coalesce(IPlayerContext ctx, BlockPos loc, List<BlockPos> locs) {
        ...
        boolean downwardGoal = locs.contains(loc.down()) || (Baritone.settings().internalMiningAirException.get() && BlockStateInterface.getBlock(ctx, loc.down()) 
        		== Blocks.air);
    ...
    public static List<BlockPos> droppedItemsScan(List<Block> mining, World world) {
        ...
        for (Entity entity : world.loadedEntityList) {
            if (entity instanceof EntityItem) {
                ...
                if (searchingFor.contains(ei.getEntityItem().getItem())) {
