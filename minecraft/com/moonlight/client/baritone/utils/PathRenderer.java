...
public final class PathRenderer implements Helper {
    ...
    private static final WorldRenderer BUFFER = TESSELLATOR.getWorldRenderer();
    ...
    public static void render(RenderEvent event, PathingBehavior behavior) {
        ...
        if (renderView.getEntityWorld() != BaritoneAPI.getProvider().getPrimaryBaritone().getPlayerContext().world()) {
    ...
    public static void drawPath(IPath path, int startIndex, Entity player, float partialTicks, Color color, boolean fadeOut, int fadeStart0, int fadeEnd0) {
        ...
        GL11.glLineWidth(Baritone.settings().pathRenderLineWidthPixels.get());
    ...
    public static void drawDankLitGoalBox(Entity player, Goal goal, float partialTicks, Color color) {
        ...
        if (goal instanceof IGoalRenderPos) {
            ...
            if (Baritone.settings().renderGoalXZBeacon.get()) {
                ...
                mc.getTextureManager().bindTexture(TileEntityBeaconRenderer.beaconBeam);
        ...
        GL11.glLineWidth(Baritone.settings().goalRenderLineWidthPixels.get());
        GlStateManager.disableTexture2D();
        GlStateManager.depthMask(false);
        if (Baritone.settings().renderGoalIgnoreDepth.get()) {
            GlStateManager.disableDepth();
