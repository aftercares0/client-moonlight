...
package com.moonlight.client.baritone.utils.pathing;
...
import com.moonlight.client.baritone.cache.CachedWorld;
...
import com.moonlight.client.baritone.pathing.path.SplicedPath;
...
public class SegmentedCalculator {
    ...
    private void loadAdjacent(int blockX, int blockZ) {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            BetterBlockPos toLoad = bp.offset(EnumFacing.getHorizontal(i), 16);
