...
import com.moonlight.client.module.impl.others.autojoin.HypixelAutoJoin;
...
@ModuleInfo(name = "AutoJoin", description = "not the true autoplay" , category = Category.OTHERS)
public class AutoJoin extends Module {

	private ModeValue mode = new ModeValue("Mode", this, new HypixelAutoJoin(this, "Hypixel"));
