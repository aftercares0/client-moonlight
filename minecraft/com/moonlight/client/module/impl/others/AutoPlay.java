...
@ModuleInfo(name = "AutoPlay", description = "the true auto play boyss" , category = Category.OTHERS)
public class AutoPlay extends Module {

	private ModeValue mode = new ModeValue("Mode", this, new NormalAutoPlay(this, "Normal"));
