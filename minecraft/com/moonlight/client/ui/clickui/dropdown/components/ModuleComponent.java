...
import com.moonlight.client.ui.clickui.dropdown.components.settings.BooleanComponent;
import com.moonlight.client.ui.clickui.dropdown.components.settings.ModeComponent;
...
public class ModuleComponent extends Component {
	...
	public void drawScreen(int mouseX, int mouseY) {
		...
		RenderUtil.drawRect(x, y, width, height, new Color(0, 0, 0, 190).getRGB());
		Fonts.productSans18.drawString(module.getName().toLowerCase(), x + 4, (int) (y + (height / 2) -
				(Fonts.productSans18.getHeight() / 2)), module.isEnabled() ? Client.MAIN_COLOR.getRGB() : -1);
