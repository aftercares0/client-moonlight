...
public class PanelComponent extends Component {
	...
	public void drawScreen(int mouseX, int mouseY) {
		...
		RenderUtil.drawRoundedRect(x, y, width, height - 1, 3, color.getRGB(), 1);
		RenderUtil.drawRect(x, y + height - 1, width, 1, color.darker().getRGB());
		Fonts.productSans18.drawString(category.getName(), x + 4, (int) (y + (height / 2) - 
