...
public class HudConfigNumber extends SettingComponent {
    ...
    public HudConfigNumber(NumberValue value, int x, int y) {
        this.x = x;
        this.y = y;
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        Fonts.productSans18.drawString(s.toLowerCase(), x + 10, (float) (y + (height / 2)
