package com.moonlight.client.util.visuals.shader;
	...
	public static int createShader(String fragementShader, String vertexShader) {
		...
		try {
			glAttachShader(program, create(
	                MinecraftInstance.mc.getResourceManager().getResource(new ResourceLocation("moonlight/shader/" + vertexShader)).getInputStream(), GL_VERTEX_SHADER));
	        glAttachShader(program, create(
	        		MinecraftInstance.mc.getResourceManager().getResource(new ResourceLocation("moonlight/shader/" + 
