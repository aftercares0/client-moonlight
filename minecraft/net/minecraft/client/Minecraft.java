...
import com.moonlight.client.baritone.api.event.events.BlockInteractEvent;
import com.moonlight.client.baritone.api.event.events.WorldEvent;
import com.moonlight.client.baritone.api.event.events.type.EventState;
...
import com.moonlight.client.module.impl.exploit.Disabler;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
                ...
                while (this.running)
                {
                    if (!this.hasCrashed || this.crashReporter == null)
                    {
                        ...
                        catch (OutOfMemoryError var10)
                        {
                            ...
                            //FUCK MOJANG, THIS CAUSE FUCKING MEMORY LEAKS
                            //System.gc();
                        }
                    }
                    else
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        ((com.moonlight.client.baritone.Baritone) BaritoneAPI.getProvider().getPrimaryBaritone()).init();
    ...
    private void runGameLoop() throws IOException
    {
        ...
        {
            this.runTick();	
//        	LoginProtectionHandler.randomShit();
        }
    ...
    private boolean isAllowUserInput(GuiScreen screen) {
        ...
        return (BaritoneAPI.getProvider().getPrimaryBaritone().getPathingBehavior().getCurrent() != null && thePlayer != null) || screen.allowUserInput;
    }
    ...
    {	
        ...
        if (this.currentScreen == null && this.thePlayer != null)
        {
        	for (IBaritone ibaritone : BaritoneAPI.getProvider().getAllBaritones()) {
        		...
        		com.moonlight.client.baritone.api.event.events.TickEvent.Type type = ibaritone.getPlayerContext().player() != null && ibaritone.getPlayerContext().world() != null
                        ? com.moonlight.client.baritone.api.event.events.TickEvent.Type.IN
                        : com.moonlight.client.baritone.api.event.events.TickEvent.Type.OUT;

                ibaritone.getGameEventHandler().onTick(new com.moonlight.client.baritone.api.event.events.TickEvent(EventState.PRE, type));
            }
        ...
        if (this.currentScreen == null || isAllowUserInput(currentScreen))
        {
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    {
                        KeyEvent event = (KeyEvent) new KeyEvent(k).fire();

                        if(event.isCancelled()) k = 0;
    ...
    {
    	if (this.theWorld != null && worldClientIn != null) {
