...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdateWalkingPlayer()
    {
        ...
        PreMotionEvent event = (PreMotionEvent) new PreMotionEvent(posX, this.getEntityBoundingBox().minY, posZ, rotationPitch, rotationYaw, onGround).fire();
    ...
    public void sendChatMessage(String message)
    {
        if(message.startsWith(".")) {
            Client.INSTANCE.commandManager.handle(message);
    ...
    public void onLivingUpdate()
    {
        ...
        float oldForward = this.movementInput.moveForward;
        if(reSprint == 2) {
        ...
        {
            SlowDownEvent event = (SlowDownEvent) new SlowDownEvent().fire();
        ...
        if (this.onGround && !flag1 && !flag2 && (this.movementInput.moveForward >= f) && 
        		!this.isSprinting() && flag3 && (!this.isUsingItem() ||
        				Client.INSTANCE.moduleManager.get(NoSlow.class).isEnabled()) && !this.isPotionActive(Potion.blindness))
        {
        ...
        if (!this.isSprinting() && (this.movementInput.moveForward >= f) && flag3 && (!this.isUsingItem() ||
				Client.INSTANCE.moduleManager.get(NoSlow.class).isEnabled()) && !this.isPotionActive(Potion.blindness) && this.mc.gameSettings.keyBindInventory.isKeyDown())
        {
            this.setSprinting(true);
        }
        ...
        if(reSprint == 2) {
            this.movementInput.moveForward = oldForward;
            reSprint = 1;
        }
