...
public class Gui
{
    ...
    public static void drawModalRectWithCustomSizedTexture(float x, float y, float u, float v, float w, float h, float textureWidth, float textureHeight)
    {
        ...
        worldrenderer.pos((double)(x + w), (double)(y + h), 0.0D).tex((double)((u + (float)w) * f), (double)((v + (float)h) * f1)).endVertex();
        worldrenderer.pos((double)(x + w), (double)y, 0.0D).tex((double)((u + (float)w) * f), (double)(v * f1)).endVertex();
