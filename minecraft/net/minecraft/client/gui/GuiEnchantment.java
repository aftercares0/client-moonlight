        ...
        for (int j = 0; j < 3; ++j)
        {
            ...
            if (this.isPointInRegion(60, 14 + 19 * j, 108, 17, mouseX, mouseY) && k > 0 && l >= 0)
            {
                ...
                if (l >= 0 && Enchantment.getEnchantmentById(l & 255) != null)
                {
                    ...
                    list.add(TextFormatting.WHITE.toString() + TextFormatting.ITALIC.toString() + I18n.format("container.enchant.clue", new Object[] {s}));
                }
                ...
                if (!flag)
                {
                    ...
                    else
                    {
                        ...
                        if (i >= i1)
                        {
                            list.add(TextFormatting.GRAY.toString() + "" + s1);
                        }
                        else
                        {
                            list.add(TextFormatting.RED.toString() + "" + s1);
                        }
