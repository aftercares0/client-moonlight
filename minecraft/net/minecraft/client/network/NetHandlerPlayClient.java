...
import com.moonlight.client.baritone.api.event.events.ChunkEvent;
...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public void handleChunkData(S21PacketChunkData packetIn)
    {
        ...
        for (IBaritone ibaritone : BaritoneAPI.getProvider().getAllBaritones()) {
            if (ibaritone.getPlayerContext().player().sendQueue == (NetHandlerPlayClient) (Object) this) {
    ...
    public void handleCombatEvent(S42PacketCombatEvent packetIn)
    {
        ...
        else if (packetIn.eventType == S42PacketCombatEvent.Event.ENTITY_DIED)
        {
            ...
            if (entity1 instanceof EntityPlayer)
            {
                ...
                if(entity1 == MinecraftInstance.mc.thePlayer) {
                	for (IBaritone ibaritone : BaritoneAPI.getProvider().getAllBaritones()) {
                        if (ibaritone.getPlayerContext().player().sendQueue == (NetHandlerPlayClient) (Object) this) {
    ...
    public void handleTeams(S3EPacketTeams packetIn)
    {
        ...
        if (packetIn.getAction() == 0 || packetIn.getAction() == 2)
        {
            ...
            scoreplayerteam.setChatFormat(TextFormatting.func_175744_a(packetIn.getColor()));
