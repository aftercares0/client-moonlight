...
public class KeyBinding implements Comparable<KeyBinding>
{
    ...
    {
    	ForceUseStop event = new ForceUseStop(pressed);
    	
    	if(MinecraftInstance.mc.gameSettings != null && this == MinecraftInstance.mc.gameSettings.keyBindDrop) {
    		event.fire();
