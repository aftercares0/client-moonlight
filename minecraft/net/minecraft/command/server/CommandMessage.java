    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException
    {
        ...
        else
        {
            ...
            else
            {
                ...
                chatcomponenttranslation.getChatStyle().setColor(TextFormatting.GRAY).setItalic(Boolean.valueOf(true));
                chatcomponenttranslation1.getChatStyle().setColor(TextFormatting.GRAY).setItalic(Boolean.valueOf(true));
