...
public abstract class Entity implements ICommandSender
{
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        else
        {
            ...
            double d4 = y;
            double d5 = z;
            boolean flag = this.onGround && this.isSneaking() && this instanceof EntityPlayer || safeWalk;
     ...
     */
    private RotationMoveEvent moveRotationEvent;
    ...
    public void moveFlying(float strafe, float forward, float friction)
    {
        ...
        if(this == MinecraftInstance.mc.thePlayer && BaritoneComponent.isActive) {
            ...
            if (baritone != null) {
                this.moveRotationEvent = new RotationMoveEvent(RotationMoveEvent.Type.MOTION_UPDATE, event.getYaw());
                baritone.getGameEventHandler().onPlayerRotationMove(this.moveRotationEvent);
            }
            
            if (BaritoneAPI.getProvider().getBaritoneForPlayer((EntityPlayerSP) (Object) this) != null) {
                event.setYaw(this.moveRotationEvent.getYaw());
            }
        }
    ...
    public Vec3d getPositionEyesCustom(float partialTicks) {
    	if (partialTicks == 1.0F)
        {
