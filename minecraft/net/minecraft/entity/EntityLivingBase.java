...
import com.moonlight.client.module.impl.visuals.Animations;
...
public abstract class EntityLivingBase extends Entity
{
    ...
    protected void updateArmSwingProgress()
    {
        ...
        {
            Animations animations = Client.INSTANCE.moduleManager.get(Animations.class);
            if(animations.isEnabled()) {
                this.swingProgressInt += animations.speed.getValue();
            }else {
    ...
    {
    	if(sprinting && this == MinecraftInstance.mc.thePlayer) {
    		StartSprintEvent event = (StartSprintEvent) new StartSprintEvent().fire();
    ...
    protected void jump()
    {
        ...
        if(this == MinecraftInstance.mc.thePlayer) {
            event.fire();
            
            if(event.isCancelled()) return;
        }

        if(this == MinecraftInstance.mc.thePlayer && BaritoneComponent.isActive) {
            ...
            if (BaritoneAPI.getProvider().getBaritoneForPlayer((EntityPlayerSP) (Object) this) != null) {
                event.setYaw(this.jumpRotationEvent.getYaw());
            }
        }
