...
public final class ItemStack
{
    ...
    public boolean onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumFacing side, float hitX, float hitY, float hitZ)
    {
        ...
        if(getItem() != null && getItem() instanceof ItemBlock) {
            new PostBlockPlace().fire();
        }
    ...
    public List<String> getTooltip(EntityPlayer playerIn, boolean advanced)
    {
        ...
        if (this.hasTagCompound())
        {
            ...
            if (this.stackTagCompound.hasKey("display", 10))
            {
                ...
                if (nbttagcompound.hasKey("color", 3))
                {
                    ...
                    {
                        list.add(TextFormatting.ITALIC + StatCollector.translateToLocal("item.dyed"));
                    }
                }
                ...
                if (nbttagcompound.getTagId("Lore") == 9)
                {
                    ...
                    if (nbttaglist1.tagCount() > 0)
                    {
                        ...
                        {
                            list.add(TextFormatting.DARK_PURPLE + "" + TextFormatting.ITALIC + nbttaglist1.getStringTagAt(j1));
                        }
                    }
                }
            }
        ...
        if (!multimap.isEmpty() && (i1 & 2) == 0)
        {
            ...
            for (Entry<String, AttributeModifier> entry : multimap.entries())
            {
                ...
                if (d0 > 0.0D)
                {
                    list.add(TextFormatting.BLUE + StatCollector.translateToLocalFormatted("attribute.modifier.plus." + attributemodifier.getOperation(), new Object[] {DECIMALFORMAT.format(d1), StatCollector.translateToLocal("attribute.name." + (String)entry.getKey())}));
                }
                else if (d0 < 0.0D)
                {
                    d1 = d1 * -1.0D;
                    list.add(TextFormatting.RED + StatCollector.translateToLocalFormatted("attribute.modifier.take." + attributemodifier.getOperation(), new Object[] {DECIMALFORMAT.format(d1), StatCollector.translateToLocal("attribute.name." + (String)entry.getKey())}));
                }
            }
        }
        ...
        {
            list.add(TextFormatting.BLUE + StatCollector.translateToLocal("item.unbreakable"));
        }
        ...
        if (this.hasTagCompound() && this.stackTagCompound.hasKey("CanDestroy", 9) && (i1 & 8) == 0)
        {
            ...
            {
                list.add("");
                list.add(TextFormatting.GRAY + StatCollector.translateToLocal("item.canBreak"));
        ...
        if (this.hasTagCompound() && this.stackTagCompound.hasKey("CanPlaceOn", 9) && (i1 & 16) == 0)
        {
            ...
            {
                list.add("");
                list.add(TextFormatting.GRAY + StatCollector.translateToLocal("item.canPlace"));
