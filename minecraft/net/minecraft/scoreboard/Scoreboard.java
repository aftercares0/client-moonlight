    ...
    public static String getObjectiveDisplaySlot(int p_96517_0_)
    {
        switch (p_96517_0_)
        {
            ...
            default:
                ...
                {
                    TextFormatting enumchatformatting = TextFormatting.func_175744_a(p_96517_0_ - 3);

                    if (enumchatformatting != null && enumchatformatting != TextFormatting.RESET)
                    {
    ...
    public static int getObjectiveDisplaySlotNumber(String p_96537_0_)
    {
        ...
        else
        {
            if (p_96537_0_.startsWith("sidebar.team."))
            {
                ...
                TextFormatting enumchatformatting = TextFormatting.getValueByName(s);
